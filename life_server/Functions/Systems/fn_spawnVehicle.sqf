...
_query = format["SELECT id, side, classname, type, pid, alive, active, plate, color, insure, inventory, gear, fuel FROM vehicles WHERE id='%1' AND pid='%2'",_vid,_pid];
...
[1,"Your vehicle is ready and insured!"] remoteExecCall ["life_fnc_broadcast",_unit];
}
else {
