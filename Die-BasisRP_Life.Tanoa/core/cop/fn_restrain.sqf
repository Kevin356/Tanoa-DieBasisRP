...
[] spawn {
	...
	while {true} do {
		...
		if(!([west,getPos player,30] call life_fnc_nearUnits) || ([civilian,getPos player,30] call life_fnc_nearUnits) && (player GVAR ["restrained",FALSE]) && vehicle player == player) exitWith {
